    ...
    <div className={`site-shell ${monsoon ? "is-monsoon" : ""} ${chaiOpen ? "is-chai" : ""}`}>
      ...
      <main>
        ...
        <section className="contact-section section-shell" id="contact">
          ...
          <div className="contact-bottom"><p>Bring the complicated brief. I’ll help make the product path obvious, useful, and worth using.</p><div className="social-links"><a href="https://github.com/omnandurkar" target="_blank" rel="noreferrer"><Github size={16} /> GitHub</a><a href="https://www.linkedin.com/in/om-nandurkar17/" target="_blank" rel="noreferrer"><Linkedin size={16} /> LinkedIn</a><a href={`mailto:${profile.email}`}><Mail size={16} /> Email</a></div></div>
        </section>
      </main>
