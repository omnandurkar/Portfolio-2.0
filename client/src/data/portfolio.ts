...
const projects: Project[] = [
  ...
  // --- Normal Projects (Custom Order) ---
  makeProject({ title: "System", type: "Full stack", category: "Gamified productivity", description: "A game-like productivity concept that brings daily tasks, progress tracking, and longer-term progression into one personal system.", stack: ["Next.js", "PostgreSQL", "Prisma", "Framer Motion"], liveUrl: "https://its-mysystem.vercel.app", accent: "red", focus: "the feedback loop between tasks, progress, and motivation", coverImage: "/assets/System-cover-img.png", evidence: { label: "Verified GitHub repository", repositoryName: "System", repositoryUrl: "https://github.com/omnandurkar/System" } }),
  makeProject({ title: "Zentry UI", type: "Frontend", category: "Interface study", description: "A visually detailed interface exploration.", stack: ["React", "Tailwind CSS"], liveUrl: "https://zentry-sage.vercel.app/", accent: "green", focus: "a visually precise interface study", coverImage: "/assets/zentry-cover-img.png", evidence: { label: "Verified GitHub repository", repositoryName: "Zentry", repositoryUrl: "https://github.com/omnandurkar/Zentry" } }),
  makeProject({ title: "Cyberfication", type: "Frontend", category: "Creative web", description: "A high-energy experimental frontend experience.", stack: ["JavaScript", "Creative web"], liveUrl: "https://cyberfiction-three.vercel.app/", accent: "yellow", focus: "expressive visual pacing", coverImage: "/oldAssets/cyberfication.png", evidence: { label: "Verified GitHub repository", repositoryName: "CYBERFICTION", repositoryUrl: "https://github.com/omnandurkar/CYBERFICTION" } }),
  makeProject({ title: "One8sports", type: "Frontend", category: "Sports commerce", description: "A sports-focused frontend site.", stack: ["Next.js", "React Three Fiber", "Three.js", "Framer Motion"], liveUrl: "https://www.one8sport.in/", accent: "yellow", focus: "sports-oriented product presentation", coverImage: "/oldAssets/One8sport.png", evidence: { label: "Verified GitHub repository", repositoryName: "one8sport.in", repositoryUrl: "https://github.com/omnandurkar/one8sport.in" } }),
  makeProject({ title: "XORA", type: "Frontend", category: "SaaS landing page", description: "A conversion-led SaaS landing page.", stack: ["React", "Framer Motion", "Tailwind CSS"], liveUrl: "https://xora-seven.vercel.app/", accent: "red", focus: "a focused SaaS landing experience", coverImage: "/oldAssets/XORA.jpg", evidence: { label: "Verified GitHub repository", repositoryName: "xora", repositoryUrl: "https://github.com/omnandurkar/xora" } }),
  makeProject({ title: "MacBook Three JS", type: "Frontend", category: "3D", description: "An exploratory product scene in Three.js.", stack: ["React", "React Three Fiber", "Three.js", "Framer Motion"], liveUrl: "https://mac-three-js.vercel.app/", accent: "green", focus: "an exploratory 3D product scene", coverImage: "/oldAssets/macbook.png", evidence: { label: "Verified GitHub repository", repositoryName: "MacThreeJs", repositoryUrl: "https://github.com/omnandurkar/MacThreeJs" } }),
  makeProject({ title: "Coffee Shop", type: "Frontend", category: "Hospitality", description: "A warm, visual café landing page.", stack: ["React"], liveUrl: "https://coffee-shop17.vercel.app/", accent: "red", focus: "a warm hospitality first impression", coverImage: "/oldAssets/coffeeshop.jpg", evidence: { label: "Verified GitHub repository", repositoryName: "Coffee-Shop", repositoryUrl: "https://github.com/omnandurkar/Coffee-Shop" } }),
  makeProject({ title: "FoodoBar", type: "Frontend", category: "Food", description: "A food-focused frontend interface.", stack: ["HTML", "CSS", "JavaScript"], liveUrl: "https://foodobar.netlify.app/", accent: "green", focus: "a food-first browsing experience", coverImage: "/oldAssets/foodobar.jpg", evidence: { label: "Verified GitHub repository", repositoryName: "FoodoBAR", repositoryUrl: "https://github.com/omnandurkar/FoodoBAR" } }),
  makeProject({ title: "Doraemon Gadget Store", type: "Frontend", category: "Commerce", description: "A playful gadget-store user interface.", stack: ["HTML", "CSS", "JavaScript"], liveUrl: "https://doraemon-gadget-store.netlify.app/", accent: "yellow", focus: "a playful commerce presentation", coverImage: "/oldAssets/doraemon.png", evidence: { label: "Verified GitHub repository", repositoryName: "Gadget-Store", repositoryUrl: "https://github.com/omnandurkar/Gadget-Store" } }),

  // --- Normal Projects (Rest) ---
  ...
  makeProject({ title: "Easy Tickets", type: "Full stack", category: "Ticketing platform", description: "A product-oriented ticketing experience designed around clear flows and fast access.", stack: ["JavaScript", "Web platform"], liveUrl: "https://easytickets.vercel.app/", accent: "red", focus: "clear ticketing flows and fast access", coverImage: "/oldAssets/easyticket.jpg", evidence: { label: "Verified GitHub repository", repositoryName: "EasyTicket", repositoryUrl: "https://github.com/omnandurkar/EasyTicket" } }),
  makeProject({ title: "Smart Dustbin", type: "Full stack", category: "Smart utility", description: "A connected utility product concept.", stack: ["JavaScript", "Product concept"], liveUrl: "https://dustbin-ruddy.vercel.app/", accent: "green", focus: "a connected utility concept", coverImage: "/oldAssets/smartdustbin.jpg", evidence: { label: "Verified GitHub repository", repositoryName: "Dustbin", repositoryUrl: "https://github.com/omnandurkar/Dustbin" } }),
  ...
  makeProject({ title: "Tracer", type: "Full stack", category: "Digital journaling", description: "A secure journaling product for capturing thoughts, tracking moods, and reflecting on patterns.", stack: ["Next.js", "React", "Prisma", "Tailwind CSS"], liveUrl: "https://tracer-ai.vercel.app/", legacyArchive: true, accent: "red", focus: "calm capture and later reflection", coverImage: "/oldAssets/tracer.png", evidence: { label: "Verified GitHub repository", repositoryName: "Tracer", repositoryUrl: "https://github.com/omnandurkar/Tracer" } }),
...
export const experiences = [
  ...
  },
  {
    ...
    imageUrl: "assets/stoic-salamander-logo.png"
  },
  {
    ...
    imageUrl: "assets/roadtocodelogo.png"
  },
];
